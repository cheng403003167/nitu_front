<template>
  <div class="container_con">
    ...
    <div class="pagination">
      <span>
        <nuxt-link v-for="(item,index) in pag_nums" :class="curPage == item?'active':''" :key="index" :to="'/pages/'+item">{{item}}</nuxt-link>
      </span>
...
export default {
  asyncData ({ params }) {
    ...
    .then((res) => {
      ...
      return {datas: res.data.article_list.reverse().slice(0,5),pag_nums:pag_num,curPage:1,article_type: res.data.article_type};
    })
  },
  data(){
    return {
